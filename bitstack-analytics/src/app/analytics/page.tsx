      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-8">
          <div className="text-center py-16">
            ...
            <p className="text-gray-600 mb-6">Create a portfolio and add assets to view analytics</p>
        ...
        {activePortfolio && (
          <div className="bg-white rounded-lg shadow-sm border p-6 mb-8">
            <div className="flex items-center justify-between">
              <div>
                <h2 className="text-xl font-semibold text-gray-900">{activePortfolio.name}</h2>
                <p className="text-gray-600">
                  Current Value: {formatCurrency(activePortfolio.metrics.totalValue)} • 
                  Total P&L: <span className={activePortfolio.metrics.totalPnL >= 0 ? 'text-green-600' : 'text-red-600'}>
              ...
              <div className="text-right">
                ...
                <p className="text-2xl font-bold text-gray-900">{activePortfolio.assets.length}</p>
              </div>
            </div>
          </div>
        )}
        ...
        {metrics && (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div className="bg-white p-6 rounded-lg shadow-sm border">
              ...
              <p className={`text-2xl font-bold ${metrics.sharpeRatio >= 0 ? 'text-green-600' : 'text-red-600'}`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          <div className="bg-white rounded-lg shadow-sm border">
            <div className="p-6 border-b">
              ...
              <p className="text-sm text-gray-600">Historical value over time</p>
            </div>
            <div className="p-6">
              {isLoading ? (
          ...
          <div className="bg-white rounded-lg shadow-sm border">
            <div className="p-6 border-b">
              ...
              <p className="text-sm text-gray-600">Portfolio composition breakdown</p>
            </div>
            <div className="p-6">
        ...
        <div className="bg-white rounded-lg shadow-sm border mb-8">
          ...
          <div className="p-6">
            {isLoading ? (
              ...
              <CorrelationMatrix correlations={correlationMatrix} assets={uniqueAssets} />
            )}
          </div>
        </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2 text-xs text-gray-600">
                    <p><strong>Sharpe Ratio:</strong> Higher is better (1+ is good)</p>
                    <p><strong>Beta:</strong> Market sensitivity (1+ = more volatile)</p>
                    <p><strong>Alpha:</strong> Excess return vs market</p>
                    <p><strong>Max Drawdown:</strong> Largest decline from peak</p>
                    <p><strong>R-Squared:</strong> Correlation with market</p>
                  </div>
                </div>
              </div>
            </div>
